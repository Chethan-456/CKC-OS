...
function AppRoutes() {
  ...
  return (
    <Routes>
      {/* 
        FIX: Root always shows the landing page (Index).
        Previously: user ? <Navigate to="/chat"> caused logged-in users
        to never see Index and always land on /chat instead.
      */}
      ...
      */}
      ...
      {/* Protected Routes */}
      <Route path="/chat"        element={<ProtectedRoute><SupabaseChat /></ProtectedRoute>} />
      <Route path="/devchat"     element={<ProtectedRoute><Dashboard /></ProtectedRoute>} />
      <Route path="/dashboard"   element={<ProtectedRoute><Dashboard /></ProtectedRoute>} />
      <Route path="/editor"      element={<ProtectedRoute><Ckcossupabase /></ProtectedRoute>} />
      ...
      <Route path="/aipair"      element={<ProtectedRoute><Aipair /></ProtectedRoute>} />
